...
const AdminWallets = () => {
  ...
  const [form, setForm] = useState({ user_id: '', label: '', address: '', network: 'TRC20' });
          ...
          <div className="glass rounded-lg p-4 lg:col-span-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                ...
                <input value={form.user_id} onChange={e => setForm({...form, user_id: e.target.value})} className="w-full input" />
              </div>
              <div>
